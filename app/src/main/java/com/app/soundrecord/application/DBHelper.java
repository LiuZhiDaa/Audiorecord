...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static abstract class DBHelperItem implements BaseColumns {
        ...
        public static final String COLUMN_NAME_RECORDING_SAMPLING = "sampling";
        public static final String COLUMN_NAME_RECORDING_CODE= "code";
    }
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBHelperItem.TABLE_NAME + " (" +
                    ...
                    DBHelperItem.COLUMN_NAME_RECORDING_SAMPLING + " INTEGER " + COMMA_SEP +
                    DBHelperItem.COLUMN_NAME_RECORDING_CODE + " INTEGER " + COMMA_SEP +
    ...
    public RecordingItem getItemAt(int position) {
        ...
        String[] projection = {
                ...
                DBHelperItem.COLUMN_NAME_RECORDING_SAMPLING,
                DBHelperItem.COLUMN_NAME_RECORDING_CODE
        };
        ...
        if (c.moveToPosition(position)) {
            ...
            item.setmSampling(c.getInt(c.getColumnIndex(DBHelperItem.COLUMN_NAME_RECORDING_SAMPLING)));
            item.setCode(c.getInt(c.getColumnIndex(DBHelperItem.COLUMN_NAME_RECORDING_CODE)));
            c.close();
            return item;
        }
        return null;
    ...
    public long addRecording(String recordingName, String filePath, long length,int Sampling,int code) {
        SQLiteDatabase db = getWritableDatabase();
        ...
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_SAMPLING, Sampling);
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_CODE, code);
    ...
    public long restoreRecording(RecordingItem item) {
        ...
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_SAMPLING, item.getmSampling());
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_CODE, item.getCode());
        long rowId = db.insert(DBHelperItem.TABLE_NAME, null, cv);
        if (mOnDatabaseChangedListener != null) {
            //mOnDatabaseChangedListener.onNewDatabaseEntryAdded();
        }
