...
public class ImageProgressView2 extends View {
    ...
    public ImageProgressView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        init();
    }

    public ImageProgressView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setImageDrawable(int drawable) {
        ...
        mOriginalDrawable.setAlpha(255);
    }
    ...
    private void makeDst(int w, int h) {
        ...
        mOriginalDrawable.setAlpha(100);
    }
    ...
    private void makeSrc(int w, int h) {
        ...
        mSrcCanvas.drawArc(mRectF, -90, mProgress, true, mSrcPaint);
    }
