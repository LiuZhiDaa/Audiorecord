...
import ulric.li.tool.impl.HttpToolUploadFile;
...
public class XLibFactory extends XFactory {
    ...
    {
        mXFactoryInterfaceMap = new HashMap<Class<?>, XFactoryImplementMap>();
        ...
        mXFactoryInterfaceMap.put(IHttpToolUploadFile.class, new XFactoryImplementMap(new Class<?>[]{
                HttpToolUploadFile.class
        }, new IXObject[]{
                null
        }));
